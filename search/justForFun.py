...
count = 0;
print("==================")
print("These are Successors:")
print("==================")


for k in SokobanState.successors(a):
    print("This is No:", count, "in successor list" )
    count = count + 1
    print(SokobanState.state_string(k))
    print(heur_alternate(k))
