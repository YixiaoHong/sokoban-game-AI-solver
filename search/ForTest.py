...
def heur_manhattan_distance(
        state):  # Sokoban State contains: action, gval, parent, width, height, robots, boxes, storage, obstacles
    # IMPLEMENT
...
# Test OK
def checkBorderLock(
        state):  # Check whether there is a box near border but no avaliable storage left for it on this side
...
def heur_alternate(state):
    #Print("checking:",state.index)
    checkProblemType(state)
    # IMPLEMENT
    '''a better heuristic'''
    '''INPUT: a sokoban state'''
    '''OUTPUT: a numeric value that serves as an estimate of the distance of the state to the goal.'''
    ...
    #print(SokobanState.state_string(state))
    #print("box:", totalboxManhattanDis)
    #print("robot:", robotHval(state))
    #print("====================================")
